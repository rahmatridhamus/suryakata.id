...
import com.idev.rahmatridham.imm.DescriptionActivity;
 ...
 */
public class InfoPersyarikatanFragment extends Fragment implements View.OnClickListener {
    ...
    public InfoPersyarikatanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Picasso.with(InfoPersyarikatanFragment.this.getContext()).load(daftarImage[0]).into(muhammadiyahLog);
        Picasso.with(InfoPersyarikatanFragment.this.getContext()).load(daftarImage[1]).into(aisyiahLog);
        Picasso.with(InfoPersyarikatanFragment.this.getContext()).load(daftarImage[2]).into(dikdasmenLog);
        Picasso.with(InfoPersyarikatanFragment.this.getContext()).load(daftarImage[3]).into(ipmLog);
        Picasso.with(InfoPersyarikatanFragment.this.getContext()).load(daftarImage[4]).into(immLog);
        Picasso.with(InfoPersyarikatanFragment.this.getContext()).load(daftarImage[5]).into(pemudaLog);
        Picasso.with(InfoPersyarikatanFragment.this.getContext()).load(daftarImage[6]).into(nasyiatulLog);
        Picasso.with(InfoPersyarikatanFragment.this.getContext()).load(daftarImage[7]).into(tapakSuciLog);
        Picasso.with(InfoPersyarikatanFragment.this.getContext()).load(daftarImage[8]).into(hizbulwathanLog);
...
//                startActivity(intent);
                Toast.makeText(v.getContext(), "Pimpinan Daerah Aisyiah Kabupaten Bandung", Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageViewDikdasmen:
//                uri = Uri.parse("https://www.instagram.com/himaiftelkom/"); // missing 'http://' will cause crashed
//                intent = new Intent(Intent.ACTION_VIEW, uri);
//                startActivity(intent);
                Toast.makeText(v.getContext(), "Majelis Pendidikan dasar dan Menengah PD Muhammadiyah Kabupaten Bandung", Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageViewIPM:
//                uri = Uri.parse("http://line.me/ti/p/%40fns2717v"); // missing 'http://' will cause crashed
//                intent = new Intent(Intent.ACTION_VIEW, uri);
//                startActivity(intent);
                Toast.makeText(v.getContext(), "Pimpinan Daerah Ikatan Pelajar Muhammadiyah Kabupaten Bandung", Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageViewIMM:
//                uri = Uri.parse("http://line.me/ti/p/%40tnv4574a"); // missing 'http://' will cause crashed
//                intent = new Intent(Intent.ACTION_VIEW, uri);
//                startActivity(intent);
                Toast.makeText(v.getContext(), "Pimpinan Cabang Ikatan Mahaiswa Muhammadiyah Kabupaten Bandung", Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageViewPemuda:
//                uri = Uri.parse("http://line.me/ti/p/~@lkk1194u"); // missing 'http://' will cause crashed
//                intent = new Intent(Intent.ACTION_VIEW, uri);
//                startActivity(intent);
                Toast.makeText(v.getContext(), "Pimpinan Daerah Pemuda Muhammadiyah Kabupaten Bandung", Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageViewNasyiatulAisyiah:
//                uri = Uri.parse("http://line.me/ti/p/~@jix3428m"); // missing 'http://' will cause crashed
//                intent = new Intent(Intent.ACTION_VIEW, uri);
//                startActivity(intent);
                Toast.makeText(v.getContext(), "Pimpinan Daerah Nasyiatul Aisyiah Kabupaten Bandung", Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageViewTapakSuci:
//                uri = Uri.parse("http://line.me/ti/p/%40uzo0610j"); // missing 'http://' will cause crashed
//                intent = new Intent(Intent.ACTION_VIEW, uri);
//                startActivity(intent);
                Toast.makeText(v.getContext(), "Pimpinan Daerah Tapak Suci Putera Muhammadiyah Kabupaten Bandung", Toast.LENGTH_SHORT).show();
                break;
...
//                intent = new Intent(Intent.ACTION_VIEW, uri);
//                startActivity(intent);
                Toast.makeText(v.getContext(), "Pimpinan Daerah Gerakan Kepanduan Hizbul Wathan Kabupaten Bandung", Toast.LENGTH_SHORT).show();
                break;
        }
    }
}
